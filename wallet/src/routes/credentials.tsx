...
const styles = StyleSheet.create({
    ...
    content: { padding: 20 },
    intro: { fontSize: 14, color: '#64748B', lineHeight: 20, marginBottom: 14 },
    emptyCard: {
    ...
    rp: { fontSize: 15, fontWeight: '600', color: '#0F172A', marginBottom: 2 },
    meta: { fontSize: 12, color: '#64748B' },
    remove: { color: '#FF3B30', fontSize: 14, fontWeight: '500' },
    removeAll: {
        flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
        backgroundColor: '#FFF1F0', borderRadius: 12, paddingVertical: 14, marginTop: 12,
    },
    removeAllText: { color: '#FF3B30', fontSize: 15, fontWeight: '600' },
});
